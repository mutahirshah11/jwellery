  ...
  return (
    ...
    <div className=' flex justify-center items-center '>
      ...
      <div className='absolute top-16 size-40  left-5 md:size-[250px] md:ml-10 lg:size-[370px] lg:mt-8 xl:size-[450px] xl:ml-20 xl:mt-5 animate-bounceIn'>
        ...
        <div className='inline-flex'><span className='text-white text-[20px] font-bold gap-1 md:text-[25px]  lg:text-[33px]  lg:w-[500px] xl:text-[35px]  '>NEW COLLECTION <p className=' text-[#E8CF36] '>IN DIAMONDS&quot</p></span></div>
