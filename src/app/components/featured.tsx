        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-3 my-5 xl:px-4'>
            {Jwellery.map( (items,index)=>(
                <div key={index} className='flex justify-center items-center '>
                    {/* cards */}
                    <div className='bg-[#C0C0C0] bg-opacity-15 w-[280px] h-[140px] lg:w-[315px] lg:h-[170px] xl:w-[375px]  xl:h-[200px]  mt-5 inline-flex justify-center items-center gap-5 rounded-lg hover:bg-opacity-25'>
